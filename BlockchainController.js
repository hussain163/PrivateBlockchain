...
class BlockchainController {
    ...
    // This endpoint allows you to invalidate a random block from the chain
    invalidateBlock1() {
        this.app.post("/invalidateBlock", async (req, res) => {
            
                try {
                    const result = await this.blockchain.invalidateBlock();
